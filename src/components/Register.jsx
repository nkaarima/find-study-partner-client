...
const Register = () => {
     ...
     const {createUser, updateUser, setUser,logInWithGoogle}= use(AuthContext);
    ...
    return (         
                ...
                <form onSubmit={handleRegister} className="card-body">
                  ...
                  <button onClick={handleLoginWithGoogle} className="btn g-white text-black border-[#e5e5e5]">
